...
return ( <main className="relative min-h-screen overflow-hidden bg-[#050816] text-white">
...
```
  ...
  <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
    ...
    {/* Badge */}
    <div className="mb-6 rounded-full border border-cyan-400/30 bg-cyan-400/10 px-6 py-2 text-sm font-medium tracking-wider text-cyan-300 backdrop-blur-md">
      PREMIUM NEON & ARCHITECTURAL SIGNAGE
    </div>

    {/* Main Heading */}
    <h1 className="max-w-6xl text-5xl font-black leading-tight tracking-tight md:text-7xl">
      ILLUMINATING
    ...
    <p className="mt-8 max-w-3xl text-lg leading-relaxed text-gray-300 md:text-xl">
      Custom Neon Signs • Acrylic & Metal Letters • LED Backlit Signage
      <br />
